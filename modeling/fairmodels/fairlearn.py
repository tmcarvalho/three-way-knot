...
def evaluate_fairlearn(x_train, x_test, y_train, y_test, set_sa):
    ...
    mitigator = ExponentiatedGradient(best_clf, constraints=EqualizedOdds(), max_iter=50)
    # retrain the grid search model with ExponentiatedGradient
    # https://github.com/fairlearn/fairlearn/issues/1196
